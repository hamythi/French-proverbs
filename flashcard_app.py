...
flashcards = [
    ...
    {"proverb": "Le repos est à l'esprit ce que le sommeil est au corps", 
     "anglais": "Rest is to the mind what sleep is to the body",
    "By": "Joubert", "date": "9/22/2026"},    
    ...
    {"proverb": "Il n'y a pas de hasard, il n'y a que des rendez-vous", 
     "anglais": "there're no coincidences, only things by design",
    "By": "Eluard", "date": "9/21/2026"},
